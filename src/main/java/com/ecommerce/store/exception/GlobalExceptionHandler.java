 ...
 * consistent JSON error responses instead of default Spring stack traces.
 */
...
public class GlobalExceptionHandler {
    ...
    // Triggered automatically by @Valid on DTOs (e.g. RegisterRequest) when validation fails
