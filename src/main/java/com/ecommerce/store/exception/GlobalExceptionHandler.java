...
// Catches any exception thrown anywhere in the app and turns it
// into a clean JSON error response instead of a stack trace
...
public class GlobalExceptionHandler {
    ...
    // Triggered when @Valid fails on a DTO — returns all fields that failed
