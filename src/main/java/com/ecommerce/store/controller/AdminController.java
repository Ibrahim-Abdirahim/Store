...
import com.ecommerce.store.dto.UserResponse;
...
public class AdminController {
    ...
    // PUT /api/admin/orders/1/status?status=SHIPPED — update an order's status
    ...
    // GET /api/admin/users — view all registered users (safe DTO, no passwords exposed)
    @GetMapping("/users")
    ...
    // Convert User entity to safe UserResponse DTO (no password field)
